...
<!--
Thank you for reporting a possible bug in Query-Terms-by-Post-Type.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "Query Terms by Post Type" in the list of plugins. The version number will be listed under the plugin description.
-->
