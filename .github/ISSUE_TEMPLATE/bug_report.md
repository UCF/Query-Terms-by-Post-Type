...
<!--
Thank you for reporting a possible bug in Term-Query-by-Post-Type.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "Term Query by Post Type" in the list of plugins. The version number will be listed under the plugin description.
-->
